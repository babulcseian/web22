 ...
 * **anyfile.md** : one per each page in the webpage (i.e., index (home), news, publications, work, cv and contact). They conect to the **layouts**.
 * **/_layouts** : all the layouts of the webpage (i.e., home, news, publications, work, contact). In these layouts you can insert pieces of code from **includes** directory and read recursively data lists from **data** directory.
